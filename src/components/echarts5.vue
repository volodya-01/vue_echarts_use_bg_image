    ...
    xAxis: [{
        ...
        axisLabel: {
            formatter: function (value) {
              // return this.$moment.format.formatTime('MM-dd', value);
            }
        },
        min: 'dataMin',
        max: 'dataMax',
